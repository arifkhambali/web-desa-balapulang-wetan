...
@section('title', 'Transparansi Anggaran - ' . ($identitasDesa->nama_desa ?? 'Desa'))

@section('content')
    <!-- Hero Section -->
    <section class="relative py-20 bg-slate-50 dark:bg-slate-900 overflow-hidden">
        ...
        <div class="container mx-auto px-4 relative z-10">
            <div class="text-center mb-12">
                ...
                <p class="text-slate-600 dark:text-slate-400 max-w-2xl mx-auto text-lg">
                    Rincian pelaksanaan APBDes Tahun Anggaran {{ $currentYear }} sebagai wujud keterbukaan informasi publik.
                </p>
            </div>

            <!-- Filter Tahun -->
            <div class="flex justify-center mb-12">
                <form action="{{ route('anggaran') }}" method="GET" class="bg-white dark:bg-slate-800 p-2 rounded-full shadow-lg border border-slate-100 dark:border-slate-700 flex items-center gap-2">
                    <div class="pl-4 text-slate-500 font-medium">Tahun Anggaran:</div>
                    <select name="tahun" onchange="this.form.submit()" class="bg-slate-50 dark:bg-slate-700 text-slate-800 dark:text-white font-bold py-2 px-6 rounded-full border-none focus:ring-2 focus:ring-primary cursor-pointer outline-none appearance-none">
