...
@section('title', 'Akses Ditolak - ' . ($identitasDesa->nama_desa ?? 'Desa Tundagan'))
...
<section class="min-h-screen flex items-center justify-center relative bg-gradient-to-br from-blue-600 to-cyan-600 text-white overflow-hidden">
    ...
    <div class="container mx-auto px-4 relative z-10 text-center">
        <div class="relative mb-8 animate-fade-in-up">
            <h1 class="text-9xl font-extrabold text-white/20 select-none">403</h1>
            <div class="absolute inset-0 flex items-center justify-center">
                <i class="fa-solid fa-lock text-6xl md:text-8xl text-white drop-shadow-lg"></i>
            </div>
        </div>
        
        <h2 class="text-3xl md:text-4xl font-bold mb-4 animate-fade-in-up [animation-delay:200ms]">Akses Ditolak</h2>
